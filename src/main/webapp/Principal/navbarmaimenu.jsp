                                  ...
                                  <ul>
                                      <li class="more-details">
                                        ...
                                        <!--   <a href="#!"><i class="ti-settings"></i>Settings</a>  -->
                                          <a href="<%=request.getContextPath() %>/ServeLetLogin?acao=Logout"><i class="ti-layout-sidebar-left"></i>Sair</a>
                                      </li>
                                  </ul>
                              </div>
                          </div>
                              ...
                              <li class="pcoded-hasmenu">
                                  ...
                                  <ul class="pcoded-submenu">
                                    <c:if test="${perfil == 'ADMIN'}">
                                      <li class=" ">
                                            <a href="<%=request.getContextPath() %>/ServeLetUsuarioController?acao=listarUser" class="waves-effect waves-dark">
